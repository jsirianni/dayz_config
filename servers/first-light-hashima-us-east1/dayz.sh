...
mod_cf="1559212036"
mod_vpp="1828439124"
mod_hashima="2781560371"
mod_assets="3001202420"
mode_bubaku="2482312670"
...
/usr/games/steamcmd \
    ...
    +workshop_download_item "$DAYZ_WORKSHOP_ID" "$mod_hashima" \
    +workshop_download_item "$DAYZ_WORKSHOP_ID" "$mod_assets" \
    +workshop_download_item "$DAYZ_WORKSHOP_ID" "$mode_bubaku" \
    +quit
EOF
}
...
symlinks() {
    ...
    sudo ln -sf "/opt/dayz/steamapps/workshop/content/221100/$mod_hashima" "/opt/dayz/$mod_hashima"
    sudo ln -sf "/opt/dayz/steamapps/workshop/content/221100/$mod_assets" "/opt/dayz/$mod_assets"
    sudo ln -sf "/opt/dayz/steamapps/workshop/content/221100/$mode_bubaku" "/opt/dayz/$mode_bubaku"
    ...
    eval sudo ln -sf "/opt/dayz/steamapps/workshop/content/221100/$mod_hashima/keys/*" /opt/dayz/keys/
    eval sudo ln -sf "/opt/dayz/steamapps/workshop/content/221100/$mod_assets/keys/*" /opt/dayz/keys/
    eval sudo ln -sf "/opt/dayz/steamapps/workshop/content/221100/$mode_bubaku/Keys/*" /opt/dayz/keys/
...
ExecStart=/opt/dayz/DayZServer \
    -config=serverDZ.cfg \
    -port=3101 \
    -mod="$mod_cf;$mod_vpp;$mod_hashima;$mod_assets;$mode_bubaku" \
    -BEpath=battleye \
    -profiles=profiles \
    -dologs \
    -adminlog \
